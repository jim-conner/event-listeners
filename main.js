...
const getFormInfo = (e) => {
  ...
  // Grabbing all the vlues from the forms
  ...
  document.querySelector('form').addEventListener('submit', getFormInfo)
    ...
    const ingredients = document.querySelector('#name').value;
    const bakeTemp = document.querySelector('#name').value;
    const drinkPairing = document.querySelector('#name').value;
    const imageUrl = document.querySelector('#name').value;
    const instructor = document.querySelector('#name').value;
    const iceCream = document.querySelector('#name').value;

    // Short han object notation to add values to obj
    const obj = {
      name,
      bakeTemp,
      ingredients,
    ...
    //pushing the new object up to the pies
    pies.push(obj);
